...
export const ui = {
  en: {
    ...
    'portfolio.comingSoon': 'Project write-ups are coming soon — check back shortly.',
    'blog.title': 'Blog',
  ...
  ko: {
    ...
    'portfolio.comingSoon': '프로젝트 소개 페이지를 준비 중입니다 — 곧 공개됩니다.',
    'blog.title': '블로그',
  ...
  id: {
    ...
    'portfolio.comingSoon': 'Halaman proyek sedang disiapkan — segera hadir.',
    'blog.title': 'Blog',
